      ...
      <div className="container px-4 mx-auto ">
        ...
        >
          <div className="relative">
            <div
              className="relative w-full h-[400px] rounded-3xl 
                    overflow-hidden"
            >
              <Image
                src={about1Img}
            ...
            <div
              className="absolute w-40 h-40 right-4 -bottom-8 
          ...
          <div className="space-y-6 mt-10">
            ...
            <div className="flex gap-2">
              ...
              >
                <FaWhatsapp className="w-5 h5 text-white" />
              ...
              <a
                ...
                className="flex items-center 
                    justify-center w-fit gap-2 px-4 py-2 rounded-md"
              >
                <MapPin className="w-5 h5 text-black" />
                Endereço da loja
              </a>
            </div>
          </div>
